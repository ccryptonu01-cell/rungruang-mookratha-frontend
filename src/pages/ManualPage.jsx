                ...
                {tab === "guest" && (
                    <div className="space-y-4">
                        ...
                        <ol className="list-decimal list-inside space-y-2">
                            ...
                            <li>ยืนยันการจอง และรับหมายเลขโต๊ะ</li>
                ...
                {tab === "user" && (
                    <div className="space-y-4">
                        ...
                        <ol className="list-decimal list-inside space-y-2">
                            ...
                            <li>เลือกโต๊ะ, เวลาที่ต้องการ และสั่งอาหารล่วงหน้า</li>
                            <li>ชำระเงินผ่านระบบ (PromptPay หรือ QR)</li>
                            <li>ตรวจสอบประวัติการจอง และ slip การชำระเงินได้ทุกเวลา</li>
